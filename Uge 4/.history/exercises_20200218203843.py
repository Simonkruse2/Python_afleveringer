...
def displayPopulationOverTheYears():
    lst = getSumPerSpecificHoods()

    eastpopulation = lst[0]
    westpopulation = lst[1]
    # for key, value in specificHoods.items():
    #     years.append(key)
    #     population.append(value)

    # print('EAST ------------ ', eastpopulation)
    # print('WEST ---------------', westpopulation)
    # print(years)
    ...
    plt.plot(range(1992,2015), eastpopulation, linewidth=5)
    plt.plot(range(1992,2015), westpopulation, linewidth=5)
