...
dataB = pd.read_csv('https://api.statbank.dk/v1/data/FOLK1A/CSV?delimiter=Semicolon&CIVILSTAND=U&OMR%C3%85DE=*&Tid=2020K1', delimiter=';')
...
largestCities = dataB['OMRÅDE'].sort_values[by='INDHOLD', acending=false]
print('5B')
print(largestCities)
