...
dataB = pd.read_csv('https://api.statbank.dk/v1/data/FOLK1A/CSV?delimiter=Semicolon&CIVILSTAND=TOT%2CU&OMR%C3%85DE=*&Tid=2020K1', delimiter=';')
...
aarlborg = dataB['OMRÅDE']['INDHOLD'] == 'Aarlborg'

print('5B')
print(dataB['OMRÅDE'] == 'Aarlborg')
# print(largestCities)
